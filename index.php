...
@media (max-width: 768px) {
  ...
  .case-studies-grid {
    ...
    :root {
      ...
      --soothing-bg: rgba(240, 253, 244, 0.95);
    }
    ...
    /* زر اللغة في القائمة المنزلقة للهاتف */
    ...
    @media (max-width: 992px) {
      ...
      /* إظهار زر اللغة في القائمة المنزلقة وإخفاء الزر الأصلي */
      .nav-actions {
        display: none;
      }
  ...
  .mobile-language-item {
    ...
    /* Legendary Content Section Design */
    .content-section {
      padding: 6rem 2rem;
      background: linear-gradient(135deg, var(--light), #ecfdf5);
      position: relative;
      overflow: hidden;
    }
    ...
    /* أنماط القسم مع تحسينات الاستجابة */
    .about-section {
      padding: 4rem 1rem;
    ...
    /* وسائط استعلامية للشاشات المتوسطة */
    ...
    /* وسائط استعلامية للشاشات الصغيرة جدًا */
    @media (max-width: 480px) {
      ...
      .highlight-item {
        flex-direction: row; /* تعديل مهم: جعل العناصر في صف وليس عمود */
        align-items: flex-start; /* محاذاة من الأعلى */
        text-align: left; /* نص إلى اليسار */
        margin-bottom: 1.5rem;
      }
      
      .highlight-icon {
        margin-right: 0.9rem; /* مسافة بين الأيقونة والنص */
        margin-bottom: 0;
      }
      
      .highlight-item p {
        margin-top: 0.4rem; /* محاذاة النص مع منتصف الأيقونة */
      }
    }
    /* وسائط استعلامية للشاشات الصغيرة جدًا */
@media (max-width: 480px) {
  ...
  .highlight-item {
    flex-direction: row; /* جعل العناصر في صف وليس عمود */
    align-items: flex-start; /* محاذاة من الأعلى */
    text-align: left; /* نص إلى اليسار */
    margin-bottom: 1.5rem;
  }
  ...
  .highlight-icon {
    margin-right: 0.9rem; /* مسافة بين الأيقونة والنص */
    margin-bottom: 0;
    margin-top: 0.8rem; /* إضافة رفع بسيط للأيقونة */
  }
  
  .highlight-item p {
    margin-top: 0.5rem; /* رفع النص قليلاً لمحاذاة منتصف الأيقونة */
  ...
  .footer-section::before {
    ...
    z-index: 0;
    animation: wave 14s infinite ease-in-out;
  }
  ...
  .footer-section::after {
    ...
    z-index: 0;
    animation: wave 16s infinite ease-in-out reverse;
  }
